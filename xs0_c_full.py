...
def main():
    ...
    DO_PATCH = False # args.do_patch
    DO_PATCH_ONLY = False # args.do_patch_only
    FULL_SCAN = True # args.full_scan
    MAX_ITERATIONS = 5 # args.max_iterations
    FUZZING_TIMEOUT_MINUTES = 3 # args.fuzzing_timeout
    PATCHING_TIMEOUT_MINUTES = 1 # args.patching_timeout
